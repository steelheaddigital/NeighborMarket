...
terms = %[<div>PLEASE READ THIS AGREEMENT CAREFULLY. IT CONTAINS IMPORTANT INFORMATION ABOUT YOUR RIGHTS AND OBLIGATIONS.</div>
<p>TERMS OF USE</p>
<p>1. GENERAL</p>
...
<p>WITHOUT LIMITING THE FOREGOING, THE WEBSITE OPERATOR ALSO DISUBRAIMS ALL WARRANTIES FOR OR WITH RESPECT TO: (a) THE SECURITY, RELIABILITY, TIMELINESS, ACCURACY AND PERFORMANCE OF CONTENT ACCESSED THROUGH THE SITE; (b) COMPUTER WORMS, VIRUSES, SPYWARE, ADWARE AND ANY OTHER MALWARE, MALICIOUS CODE OR HARMFUL CONTENT OR COMPONENTS ACCESSED, RECEIVED OR DISSEMINATED THROUGH, RELATED TO OR AS A RESULT OF THE WEBSTE OR CONTENT ACCESSED THROUGH THE WEBSITE; (c) ANY TRANSACTIONS OR POTENTIAL TRANSACTIONS, GOODS OR SERVICES PROMISED OR EXCHANGED, INFORMATION OR ADVICE OFFERED OR EXCHANGED, OR OTHER CONTENT, INTERACTIONS, REPRESENTATIONS OR COMMUNICATIONS THROUGH, RELATED TO OR AS A RESULT OF USE OF THE WEBSITE OR CONTENT ACCESSED THROUGH THE WEBSITE (INUBRUDING, WITHOUT LIMITATION, ACCESSED THROUGH ANY LINKS ON UBR OR IN CONTENT).</p>
...
<p>THE WEBSITE OPERATOR AND REPRESENTATIVES SHALL UNDER NO CIRCUMSTANCES BE LIABLE FOR ANY ACCESS TO, USE OF OR RELIANCE ON THE WEBSITE OR CONTENT ACCESSED THROUGH THE WEBSITE BY YOU OR ANYONE ELSE, OR FOR ANY TRANSACTIONS, COMMUNICATIONS, INTERACTIONS, DISPUTES OR RELATIONS BETWEEN YOU AND ANY OTHER PERSON OR ORGANIZATION ARISING OUT OF OR RELATED TO THE WEBSITE OR CONTENT ACCESSED THROUGH THE WEBSITE, INUBRUDING BUT NOT LIMITED TO LIABILITY FOR INJUNCTIVE RELIEF AS WELL AS FOR ANY HARM, INJURY, LOSS OR DAMAGES OF ANY KIND INCURRED BY YOU OR ANYONE ELSE (INUBRUDING, WITHOUT LIMITATION, DIRECT, INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, STATUTORY, EXEMPLARY OR PUNITIVE DAMAGES, EVEN IF UBR OR ANY UBR REPRESENTATIVE HAS BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES). THIS LIMITATION OF LIABILITY APPLIES REGARDLESS OF, BUT IS NOT RESTRICTED TO, WHETHER THE ALLEGED LIABILITY, HARM, INJURY, LOSS OR DAMAGES AROSE FROM AUTHORIZED OR UNAUTHORIZED ACCESS TO OR USE OF THE WEBSITE OR CONTENT ACCESSED THROUGH THE WEBSITE; ANY INABILITY TO ACCESS OR USE THE WEBSITE OR CONTENT ACCESSED THROUGH THE WEBSITE; OR ANY REMOVAL, DELETION, LIMITATION, MODIFICATION, INTERRUPTION, SUSPENSION, DISCONTINUANCE OR TERMINATION OF THE WEBSITE OR CONTENT ACCESSED THROUGH THE WEBSITE.</p>
