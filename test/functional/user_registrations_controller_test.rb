...
class UserRegistrationsControllerTest < ActionController::TestCase
  ...
  test "should update user" do
    ...
    put :update, :user => { :username => "updatebuyer", :email => "createseller@create.com", :current_password => user.password, :first_name => "update", :last_name => "update", :initial => "c", :phone => "503-123-4567", :address => "123 Test", :city => "Portland", :country => "US", :state => "OR", :zip => "97218", :delivery_instructions => "bring it" }
